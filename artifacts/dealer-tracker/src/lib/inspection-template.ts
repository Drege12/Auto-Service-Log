...
const DRIVER_MC_DUALSPORT_TEMPLATE = [
  ...
  { category: "Post-Ride", item: "Fluid leaks — check under bike for oil, coolant, or fork oil after ride" },
...
const DRIVER_ATV_SNOWMOBILE_TEMPLATE = [
  ...
  { category: "Post-Drive", item: "Fluid leaks — check engine cases, coolant hoses, and chaincase for any seepage" },
...
const DRIVER_ATV_DIRTBIKE_TEMPLATE = [
  ...
  { category: "Post-Drive", item: "Fluid leaks — check engine cases, fork seals, and radiator hoses after ride" },
